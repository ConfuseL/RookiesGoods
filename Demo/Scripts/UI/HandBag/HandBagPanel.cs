...
public class HandBagPanel : MonoBehaviour
{
    ...
    void UpdataBagUI()
    {
        ...
        List<RookiesGoods_Grid> items = RookiesGoods_OverallManage.GoodsManage.Try2GetPlayer(1).TryGetBag("HandBag").Try2GetGoodsMessage();
        if (items != null)
